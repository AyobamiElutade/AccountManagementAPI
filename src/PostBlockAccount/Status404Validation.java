...
public void Test (){
	...
	String BlockAccountPath = "/api/v1/account/13063727699/block";
	...
	//BaseUrl or Host
		...
		body("{"+
  "\"lockType\": \"PND\","+
  "\"blockActionReason\": \"Pls lock the account\","+
"}").	
					 
      when().
      post(BlockAccountPath).
      then().assertThat().statusCode(204).//and().contentType(ContentType.TEXT).
